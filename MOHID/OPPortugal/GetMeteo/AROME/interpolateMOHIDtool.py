...
def init(begin_date,end_date,working_dir,father_grid,convert_tool,boundary_cond_folder,mohid_meteo_filename,origin_folder,file_prefix,glue_option):
    ...
    write_log_file(working_dir + '\LogsInterpolate\interpolate_' + date1_file + '.log', stdout)
    if os.path.exists(output_file):
        ...
        # Se o ficheiro NÃO existe, o conversor crashou com aquele erro da imagem
        print("            !!! ERRO CRÍTICO: O conversor crashou ou o ficheiro não foi criado.")
        print("            (Verifique o erro 0xc000007b: falta de DLLs ou Visual C++)")
        commandResult = 0
